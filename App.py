...
def insertf_data(feed_name,feed_email,feed_score,comments,Timestamp):
    ...
    insertfeed_sql = f"""INSERT INTO {DBf_table_name}
    VALUES (NULL,?,?,?,?,?)"""
...
def run():
    ...
    img = Image.open('App/Logo/RESUME.png')
    st.image(img)
    ...
    if choice == 'User':   # ✅ this must be inside run()
    ...
    # Upload Resume
    st.markdown(
        '''<h5 style='text-align: left; color: #021659;'>Upload Your Resume</h5>''',
        unsafe_allow_html=True
    )
